...
# output window
output = ctk.CTkTextbox(root, font=("Calibri", 20), width=780, height=780, fg_color="#3d3d3d", border_width=8, border_color="#8388d6", text_color="#e4e4e4", scrollbar_button_color="#e4e4e4")
output.grid(row=0, column=0, rowspan=6, padx=15, pady=(10, 10), sticky="nes")


checkbox_frame = ctk.CTkFrame(root, fg_color="transparent", border_color="#8388d6", border_width=2)
checkbox_frame.grid(row=1, rowspan=6, column=0, padx=305, pady=(10, 0), sticky="nw")


# field for text input
phrase_entry = ctk.CTkTextbox(root, font=("Calibri", 20), width=766, height=110, fg_color="#3d3d3d", border_width=8, border_color="#27b9ff", text_color="#e4e4e4", scrollbar_button_color="#e4e4e4")
phrase_entry.grid(row=0, column=0, padx=15, pady=(10, 0), sticky="nsw")
...
aug_entry.grid(row=3, column=0, padx=160, pady=(0, 0), sticky="w")
...
img_label.grid(row=5, column=0, padx=15, pady=(0, 10), sticky="sw")


# version number
version = ctk.CTkLabel(root, text="1.0", fg_color="transparent", text_color="white", font=("Calibri", 20))
version.grid(row=5, column=0, padx=80, pady=(0, 5), sticky="sw")
...
use_button.grid(row=1, rowspan=2, column=0, padx=15, pady=10, sticky="nsw")
...
train_button.grid(row=1, rowspan=2, column=0, padx=160, pady=10, sticky="nsw")
...
augment_button.grid(row=3, column=0, padx=15, pady=10, sticky="nsw")

preprocess_button = ctk.CTkButton(root, command=lambda: openfilePP(), text="Preprocess\nData", font=("Calibri", 20,"bold"), text_color="white", fg_color="#8388d6", hover_color="#95a8fe", border_width=2, border_spacing=10, border_color="#e4e4e4")
preprocess_button.grid(row=4, column=0, padx=15, pady=10, sticky="nsw")
...
demo_train_button.grid(row=4, column=0, padx=184, pady=10, sticky="nsw")
...
demo_button.grid(row=4, column=0, padx=345, pady=10, sticky="nsw")
...
clear_button.grid(row=4, column=0, padx=507, pady=10, sticky="nsw")
