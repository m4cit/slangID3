...
if __name__ == '__main__':
    ...
    # output window
    output = ctk.CTkTextbox(root, font=("Calibri", 20), width=380, fg_color="#3d3d3d", border_width=8, border_color="#8388d6", text_color="#e4e4e4", scrollbar_button_color="#e4e4e4")
    output.grid(row=0, column=1, rowspan=5, columnspan=1, padx=15, pady=(10, 10), sticky="nwes")
    ...
    # version number
    version = ctk.CTkLabel(root, text="1.1", fg_color="transparent", text_color="white", font=("Calibri", 20))
    ...
    demo_train_button.grid(row=3, column=0, rowspan=1, columnspan=2, padx=170, pady=10, sticky="nsw")
    ...
    demo_button.grid(row=3, column=0, rowspan=1, columnspan=2, padx=325, pady=10, sticky="nsw")
